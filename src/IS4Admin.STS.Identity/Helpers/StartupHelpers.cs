...
using SendGrid;
using Serilog;
using IS4Admin.STS.Identity.Configuration;
using IS4Admin.STS.Identity.Configuration.ApplicationParts;
using IS4Admin.STS.Identity.Configuration.Constants;
using IS4Admin.STS.Identity.Configuration.Intefaces;
using IS4Admin.STS.Identity.Helpers.Localization;
using IS4Admin.STS.Identity.Services;
using ILogger = Microsoft.Extensions.Logging.ILogger;

namespace IS4Admin.STS.Identity.Helpers
{
